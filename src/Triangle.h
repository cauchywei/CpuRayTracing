...
namespace crt {
    ...
    public:
        constexpr Triangle(const Vector3f& v0, const Vector3f& v1, const Vector3f& v2, const Material& material = {})
                : _vertices{v0, v1, v2}, _material(material) {}

        constexpr Triangle(Vector3f&& v0, Vector3f&& v1, Vector3f&& v2, Material&& material = {}) : _vertices{
                std::move(v0),
                std::move(v1),
                std::move(v2)},
                                                                                                    _material() {}
        ...
        [[nodiscard]] constexpr Vector3f getNormal() const {
